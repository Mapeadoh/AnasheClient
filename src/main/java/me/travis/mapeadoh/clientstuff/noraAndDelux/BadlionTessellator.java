...
{
    public static BadlionTessellator INSTANCE;
    ...
    public static void begin(final int mode) {
        BadlionTessellator.INSTANCE.getBuffer().begin(mode, DefaultVertexFormats.POSITION_COLOR);
    }
    ...
    public static void render() {
        BadlionTessellator.INSTANCE.draw();
    }
    ...
    public static void draw_cube(final float x, final float y, final float z, final int argb, final String sides) {
        ...
        final int g = argb >>> 8 & 0xFF;
        final int b = argb & 0xFF;
        draw_cube(BadlionTessellator.INSTANCE.getBuffer(), x, y, z, 1.0f, 1.0f, 1.0f, r, g, b, a, sides);
    }

    public static void draw_cube(final BlockPos blockPos, final int r, final int g, final int b, final int a, final String sides) {
        draw_cube(BadlionTessellator.INSTANCE.getBuffer(), (float)blockPos.getX(), (float)blockPos.getY(), (float)blockPos.getZ(), 1.0f, 1.0f, 1.0f, r, g, b, a, sides);
    }
    ...
    public static void draw_cube_line(final float x, final float y, final float z, final int argb, final String sides) {
        ...
        final int g = argb >>> 8 & 0xFF;
        final int b = argb & 0xFF;
        draw_cube_line(BadlionTessellator.INSTANCE.getBuffer(), x, y, z, 1.0f, 0.5645f, 1.0f, r, g, b, a, sides);
    }
    ...
    public static void draw_cube_line_full(final float x, final float y, final float z, final int argb, final String sides) {
        ...
        final int g = argb >>> 8 & 0xFF;
        final int b = argb & 0xFF;
        draw_cube_line(BadlionTessellator.INSTANCE.getBuffer(), x, y, z, 1.0f, 1.0f, 1.0f, r, g, b, a, sides);
    }
    ...
    public static void draw_cube_line(final BlockPos blockPos, final int r, final int g, final int b, final int a, final String sides) {
        draw_cube_line(BadlionTessellator.INSTANCE.getBuffer(), (float)blockPos.getX(), (float)blockPos.getY(), (float)blockPos.getZ(), 1.0f, 1.0f, 1.0f, r, g, b, a, sides);
    }

    public static BufferBuilder get_buffer_build() {
        return BadlionTessellator.INSTANCE.getBuffer();
    }
    ...
    static {
        BadlionTessellator.INSTANCE = new BadlionTessellator();
    }
}