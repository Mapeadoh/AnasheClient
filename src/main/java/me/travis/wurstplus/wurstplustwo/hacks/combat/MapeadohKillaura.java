...
public class MapeadohKillaura extends WurstplusHack {
	...
	public MapeadohKillaura() {
		...
		this.tag         = "KillAura2";
		this.description = "me caigo a pedazos";
	}

	WurstplusSetting mode = create("Mode", "KillAuraMode", "Normal", combobox("Normal", "A32k" ));
    WurstplusSetting crits = create("Criticals", "CriticalsMode", "Packet", combobox("Packet", "Jump"));
	...
	WurstplusSetting sync_tps  = create("Sync TPS", "KillAuraSyncTps", false);
	...
	public String array_detail() {
		return crits.get_current_value();
	}
