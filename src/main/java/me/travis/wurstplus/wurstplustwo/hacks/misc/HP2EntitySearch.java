...
public class HP2EntitySearch extends WurstplusHack {
    int delay;
    ...
    public void update() {
        ...
        if (this.donkeys.get_value(true)) {
            HP2EntitySearch.mc.world.loadedEntityList.forEach(entity -> {
                ...
                if (this.llamas.get_value(true)) {
                    HP2EntitySearch.mc.world.loadedEntityList.forEach(entity2 -> {
                        ...
                        if (this.mules.get_value(true)) {
                            HP2EntitySearch.mc.world.loadedEntityList.forEach(entity3 -> {
                                ...
                                if (this.slimes.get_value(true)) {
                                    HP2EntitySearch.mc.world.loadedEntityList.forEach(entity4 -> {
