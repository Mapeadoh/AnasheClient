...
public class WurstplusHoleFill extends WurstplusHack {
    ...
    WurstplusSetting mode = create("FillWithBlock", "Block", "Webs", combobox("Obi", "Webs", "EC"));
    ...
    WurstplusSetting hole_range = create("Range", "HoleFillRange", 4, 1, 10);
    WurstplusSetting swing = create("Swing", "HoleFillSwing", "None", combobox("Mainhand", "Offhand", "Both", "None"));
