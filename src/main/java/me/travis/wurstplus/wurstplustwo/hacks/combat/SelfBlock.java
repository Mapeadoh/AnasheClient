...
public class SelfBlock extends WurstplusHack {
    ...
    WurstplusSetting mode = create("Mode", "Mode", "Webs", combobox("Webs", "Skulls"));
    WurstplusSetting always_on = create("Toggle", "Toggle", false);
    ...
    public void enable() {
        ...
        if (mc.player != null) {
            ...
            String needed = mode.get_current_value();
            if (new_slot == -1) {
