...
public class WurstplusEventMotionUpdate extends MinecraftEvent {
    ...
    public WurstplusEventMotionUpdate(Stage stage, double posX, double posY, double posZ, boolean pOnGround)
    {
        super(stage);
        x = posX;
        y = posY;
