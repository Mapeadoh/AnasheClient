package me.travis.wurstplus.wurstplustwo.guiscreen.wp2clickgui.render.components.widgets;

import me.travis.wurstplus.AnasheClient;
import me.travis.wurstplus.wurstplustwo.guiscreen.wp2clickgui.render.WurstplusDraw;
import me.travis.wurstplus.wurstplustwo.guiscreen.wp2clickgui.render.components.WurstplusAbstractWidget;
import me.travis.wurstplus.wurstplustwo.guiscreen.wp2clickgui.render.components.WurstplusFrame;
import me.travis.wurstplus.wurstplustwo.guiscreen.wp2clickgui.render.components.WurstplusModuleButton;
...
public class WurstplusButtonBind extends WurstplusAbstractWidget {
	...
	public void bind(char char_, int key) {
		if (this.waiting) {
			switch (key) {
				case AnasheClient.WURSTPLUS_KEY_GUI_ESCAPE : {
					this.waiting = false;

					break;
				}

				case AnasheClient.WURSTPLUS_KEY_DELETE : {
	...
	public void render(int master_y, int separe, int absolute_x, int absolute_y) {
		...
		int ns_a = AnasheClient.click_gui.theme_widget_name_a;
