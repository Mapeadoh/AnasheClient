...
public class RenderHelp extends Tessellator {
    ...
    public static void draw_gradiant_cube(BufferBuilder get_buffer_build, int x, int y, int z, int i, float off_set_h,
            int j, Color color, Color color2, String directionsToRenderQuad) {
    }

    public static void draw_gradiant_outline(BufferBuilder get_buffer_build, int x, int y, int z, float off_set_h,
            Color color, Color color2, String directionsToRenderOutline) {
    }
}